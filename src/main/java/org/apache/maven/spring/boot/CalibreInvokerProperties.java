...
public class CalibreInvokerProperties {
	...
	/**
	 * Set the value of the {@code detach} argument. {@code true} if the argument
	 * {@code --detach} was specified, otherwise {@code false}
	 */
	private boolean detach;
	/**
	 * Set the value of the {@code ignore-plugins} {@code true} if the
	 * argument {@code --ignore-plugins} was specified, otherwise {@code false}
	 */
	private boolean ignorePlugins;
	/**
	 * Set the value of the {@code no-update-check} {@code true} if the
	 * argument {@code --no-update-check} was specified, otherwise {@code false}
	 */
	private boolean noUpdateCheck;
	/**
	 * Set the value of the {@code shutdown-running-calibre} {@code true} if the
	 * argument {@code --shutdown-running-calibre} was specified, otherwise {@code false}
	 */
	private boolean shutdownRunningCalibre;
	
	/**
	 * Set the value of the {@code start-in-tray} {@code true} if the
	 * argument {@code --start-in-tray} was specified, otherwise {@code false}
	 */
	private boolean startInTray;
